...
import (
	...
	"github.com/thebinarytrio/weighted-lottery/backend/lotteryservice-service/handlers"
...
func NewEndpoints(service pb.LotteryServiceServer) svc.Endpoints {
	// Business domain.
	...
	// Endpoint domain.
	var (
		lotteryserviceEndpoint = svc.MakeLotteryServiceEndpoint(service)
	)
...
func Run(cfg Config) {
	...
	go func() {
		...
		s := grpc.NewServer()
		pb.RegisterLotteryServiceServer(s, srv)
