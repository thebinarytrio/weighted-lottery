...
// Package http provides an HTTP client for the LotteryService service.
package http
...
func New(instance string, options ...httptransport.ClientOption) (pb.LotteryServiceServer, error) {
